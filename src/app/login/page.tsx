        ...
        <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-navy-600 via-navy-800 to-navy-900 p-10 text-white md:flex">
          ...
          <div className="relative z-10 flex items-center gap-2">
            ...
            <div className="leading-tight">
              ...
              <p className="text-sm tracking-[0.3em] text-white/80">XPERTS</p>
            </div>
          </div>
          ...
          <p className="relative z-10 text-sm text-white/60">Admin Dashboard · v0.1</p>
        </div>

        {/* Form */}
        <div className="p-8 md:p-10">
          <h1 className="text-2xl font-extrabold text-heading">Welcome back</h1>
          <p className="mt-1 text-base text-muted">Sign in to your admin account.</p>

          <form onSubmit={onSubmit} className="mt-8 space-y-4">
            <div>
              <label className="mb-1.5 block text-base font-medium text-heading">Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-border bg-surface-alt py-2.5 pl-10 pr-3 text-base text-heading outline-none focus:border-primary focus:ring-2 focus:ring-glow"
            ...
            <div>
              <label className="mb-1.5 block text-base font-medium text-heading">Password</label>
              <div className="relative">
            ...
            {error && (
              <div className="rounded-lg bg-error/10 px-3 py-2 text-base text-error">{error}</div>
            )}

            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-2.5 text-base font-semibold text-white transition hover:bg-primary-hover disabled:opacity-60"
            >
          ...
          <p className="mt-6 rounded-lg bg-surface-alt px-3 py-2 text-sm text-muted">
